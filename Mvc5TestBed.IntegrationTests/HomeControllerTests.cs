...
namespace Mvc5TestBed.IntegrationTests
{
    [TestFixture]
    public class SampleWebAppTestExample
    {
        ...
        public void TestFixtureSetUp()
        {
            ...
            appHost = AppHost.Simulate("MvcIntegrationTestFramework.SampleWebApp", true);
        }

        [Test]
        public void Root_Url_Renders_Index_View_SampleWebApp()
        {
